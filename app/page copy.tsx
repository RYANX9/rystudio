...
export default function RYDevPortfolio() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 via-white to-gray-100 min-h-screen font-sans antialiased relative overflow-hidden">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white bg-opacity-80 backdrop-blur-xl border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="/noun.svg" alt="RY Dev" className="w-8 h-8" />
            <div className="text-2xl font-light tracking-tight">RY Dev</div>
          </div>
          <div className="hidden md:flex items-center gap-8 text-sm">
            ...
            <a href="#contact" className="px-6 py-2 bg-gray-900 text-white hover:bg-gray-800 transition-colors rounded-sm">
              Contact
            </a>
          </div>
        </div>
      ...
      <div className="relative z-10">
        {/* Hero Section */}
        <section id="hero" className="pt-32 pb-24 px-6 lg:px-12 max-w-7xl mx-auto min-h-screen flex flex-col justify-center">
          <div className="mb-8 text-sm text-gray-500 tracking-widest uppercase flex items-center gap-2">
            <img src="/noun.svg" alt="" className="w-4 h-4 opacity-50" />
            Paris, France
          </div>
          <h1 className="text-6xl lg:text-8xl font-light leading-tight mb-8 tracking-tight" style={{
          ...
          <p className="text-xl lg:text-2xl text-gray-600 max-w-2xl mb-12 leading-relaxed">
          ...
          <div className="flex items-center gap-6">
            <a href="#work" className="inline-flex items-center gap-2 px-8 py-4 bg-gray-900 text-white hover:bg-gray-800 transition-all group rounded-sm">
              View Work
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </a>
            <a href="#contact" className="inline-flex items-center gap-2 px-8 py-4 border border-gray-300 hover:border-gray-900 transition-colors rounded-sm">
              Let's Talk
            </a>
          </div>
        </section>
        ...
        <section id="work" className="py-24 px-6 lg:px-12 max-w-7xl mx-auto">
          <div className="mb-16">
            <div className="text-sm text-gray-500 tracking-widest uppercase mb-4 flex items-center gap-2">
              <img src="/noun.svg" alt="" className="w-4 h-4 opacity-50" />
              Selected Work
            </div>
            <h2 className="text-5xl lg:text-6xl font-light tracking-tight mb-4">Recent Projects</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            {projects.map((project, index) => (
              ...
              >
                <div className="relative overflow-hidden mb-6 bg-gray-200 rounded-sm" style={{ paddingBottom: '66.67%' }}>
                  <img 
                    src={project.image} 
                    alt={project.title}
                    className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                  />
                  <div className="absolute top-4 right-4 px-3 py-1 bg-white text-xs tracking-wider rounded-sm">
                    {project.status}
                  </div>
                </div>
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech, i) => (
                      <span key={i} className="px-3 py-1 bg-gray-100 text-xs tracking-wider rounded-sm">
                        {tech}
                      </span>
                    ))}
                  </div>
        ...
        {/* Process Section */}
        <section id="process" className="py-24 px-6 lg:px-12 bg-white bg-opacity-80 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto">
            <div className="mb-16">
              ...
              <h2 className="text-5xl lg:text-6xl font-light tracking-tight mb-4">My Process</h2>
              <p className="text-xl text-gray-600 max-w-3xl leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
              {process.map((step, index) => (
                <div key={index} className="group">
                  <div className="text-6xl font-light text-gray-200 group-hover:text-gray-900 transition-colors mb-6">
                    {step.number}
                  </div>
        ...
        <section id="pricing" className="py-24 px-6 lg:px-12 max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            <h2 className="text-5xl lg:text-6xl font-light tracking-tight mb-6">Transparent Pricing</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricing.map((tier, index) => (
              <div 
                key={index} 
                className={`p-8 lg:p-10 border transition-all rounded-sm ${
                  tier.highlighted 
                    ? 'border-gray-900 bg-gray-900 text-white scale-105 shadow-xl' 
                    : 'border-gray-200 bg-white hover:border-gray-300 hover:shadow-lg'
                }`}
              >
                <div className="mb-8">
                  <div className={`text-sm tracking-widest uppercase mb-2 ${tier.highlighted ? 'text-gray-300' : 'text-gray-500'}`}>
                    {tier.name}
                  </div>
                  <div className="text-5xl font-light mb-2">{tier.price}</div>
                ...
                <ul className="space-y-4 mb-8">
                  {tier.features.map((feature, i) => (
                    <li key={i} className="flex items-start gap-3">
                      ...
                      <span className={tier.highlighted ? 'text-gray-100' : 'text-gray-600'}>{feature}</span>
                    </li>
                  ))}
                </ul>
                ...
                <a 
                  href="#contact" 
                  className={`block text-center py-4 transition-all rounded-sm ${
                    tier.highlighted 
        ...
        {/* Contact Section */}
        <section id="contact" className="py-24 px-6 lg:px-12 bg-white bg-opacity-80 backdrop-blur-sm">
          <div className="max-w-4xl mx-auto text-center">
            <div className="text-sm text-gray-500 tracking-widest uppercase mb-4 flex items-center justify-center gap-2">
              <img src="/noun.svg" alt="" className="w-4 h-4 opacity-50" />
              Get In Touch
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
              <a 
                ...
                className="inline-flex items-center gap-3 px-8 py-4 bg-gray-900 text-white hover:bg-gray-800 transition-colors text-lg group rounded-sm"
              >
              ...
              <a 
                ...
                className="inline-flex items-center gap-3 px-8 py-4 border border-gray-300 hover:border-gray-900 transition-colors text-lg rounded-sm"
              >
                <svg 
                  className="w-5 h-5" 
                  viewBox="0 0 16 16"
        ...
        <footer className="py-12 px-6 lg:px-12 border-t border-gray-200">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-sm text-gray-500">
              © 2025 RY Dev. All rights reserved.
            </div>
            <div className="flex items-center gap-6">
